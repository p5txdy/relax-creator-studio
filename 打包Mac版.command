...
APP_PATH="$SCRIPT_DIR/dist-macos/解压创作工坊-v0.2.4.app"
echo "[5/6] 验证应用资源"
...
hdiutil create \
  -volname "解压创作工坊 v0.2.4" \
  -srcfolder "$DMG_STAGE" \
  -ov \
  -format UDZO \
  "$SCRIPT_DIR/dist-macos/解压创作工坊-v0.2.4-macOS.dmg"

echo ""
echo "打包完成："
echo "  $APP_PATH"
echo "  $SCRIPT_DIR/dist-macos/解压创作工坊-v0.2.4-macOS.dmg"
