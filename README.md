...
1. 素材会按当前顺序和截取区间进入剪映主视频轨道。
2. 如果导入了主音频，视频会循环或截断，时间线长度严格等于主音频。
3. 主音频、可选背景音乐和 SRT 字幕会进入各自独立轨道。
4. 画幅、帧率和转场会写入草稿，剪映专业版随后自动启动。
5. 在剪映首页的“本地草稿”中打开同名项目；列表未立即刷新时，重新进入首页即可。
